...
export default function UserFeedback() {
    ...
    return (
        <Grid container spacing={2} sx={{
            ...
            <Typography variant="h2" gutterBottom>Contactanos</Typography>
            ...
            <Button sx={{marginTop: "1%", marginBottom: "1%"}} onClick={handleSubmit} variant="contained" size="medium">Mandar</Button>
        </Grid>
    )
}