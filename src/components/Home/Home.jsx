  ...
  return (
    <div>
      ...
      <div className="container">
        ...
        <h3 className="h3">La Patagonia es una de las regiones más hermosas y salvajes de América del Sur. Con vastas llanuras, majestuosas montañas y glaciares, bosques imponentes y una fauna única. Con 
          nuetros servicios vas a poder asegurarte un viaje placentero y relajado, aprovechando al maximo tu tiempo y disfrutando de todos los lugares imperdibles de este maravilloso lugar.
        </h3>
