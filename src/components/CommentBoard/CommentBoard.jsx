              ...
              >
                ...
                <Typography display='inline' variant='subtitle1'>
                  ...
                  <ButtonGroup sx={{ marginRight: '3%', color: 'red' }}>
                    ...
                    >
                      {hearts > 0 ? <FavoriteIcon /> : <FavoriteBorderIcon />}
                    </Button>
                    <Button
                      sx={{ color: 'red' }}
                      size='large'
                    ...
                    >
                      {hearts > 1 ? <FavoriteIcon /> : <FavoriteBorderIcon />}
                    </Button>
                    <Button
                      sx={{ color: 'red' }}
                      size='large'
                    ...
                    >
                      {hearts > 2 ? <FavoriteIcon /> : <FavoriteBorderIcon />}
                    </Button>
                    <Button
                      sx={{ color: 'red' }}
                      size='large'
                    ...
                    >
                      {hearts > 3 ? <FavoriteIcon /> : <FavoriteBorderIcon />}
                    </Button>
                    <Button
                      sx={{ color: 'red' }}
                      size='large'
                    ...
                    >
                      {hearts > 4 ? <FavoriteIcon /> : <FavoriteBorderIcon />}
                    </Button>
                  </ButtonGroup>
                </Typography>
              </Box>
